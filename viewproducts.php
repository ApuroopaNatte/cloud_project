...
$count = mysqli_query($con, "SELECT * FROM  products where store='$username'");
...
$sql ="SELECT * FROM  products where store='$username' LIMIT $row_start, $per_page";
				...
				<div class="panel-body">
					...
					<div class="table-responsive">
						<table class="table table-striped table-bordered table-hover"
							...
							<?php $sno=1;$i = $row_start; while($row = mysqli_fetch_assoc($result))  {  $i++;?>
								...
								<tr>
									...
									<td><a
										href="deleteproduct.php?pid=<?php echo $row ['pid']; ?>" />Delete
										</a></td>
