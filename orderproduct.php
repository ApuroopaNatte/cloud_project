...
if (isset($_POST['submit'])) {
    ...
    $orderstatus="pending";
	$username=$_SESSION['username'];
	echo $id." ".$odate." ".$orderstatus." ".$username;
    $usql = "INSERT INTO `orders` VALUES (null,'$username','$id','$odate','$orderstatus')";
					...
					<div class="row">
						...
						<div class="col-50">
							...
							<div class="row">
								...
								<div class="col-50">
									<label for="expyear">IFSC CODE</label> <input type="text"
